...
{
    Fmatrix mInvCamera;
    Fvector _VR, _VU, _VT, _VP;

    mInvCamera.invert(Device.mView);
    _VR.set(mInvCamera._11, mInvCamera._12, mInvCamera._13);
    _VU.set(mInvCamera._21, mInvCamera._22, mInvCamera._23);
    _VT.set(mInvCamera._31, mInvCamera._32, mInvCamera._33);
    _VP.set(mInvCamera._41, mInvCamera._42, mInvCamera._43);
    Log("CCameraManager::Dump::vPosition = ", _VP);
    Log("CCameraManager::Dump::vDirection = ", _VT);
    Log("CCameraManager::Dump::vNormal = ", _VU);
    Log("CCameraManager::Dump::vRight = ", _VR);
}
